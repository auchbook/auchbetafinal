    ...
    if (checkbox.checked) {
        ...
        switch (element.querySelector('span').innerText) {
            ...
            case 'Capítulo Quatro - A Última Esperança':
                message = 'Parabéns, você finalizou a leitura do capítulo quatro e desbloqueou alguns itens:<br><br>- Comentários da autora sobre o capítulo quatro<br>- Brinde 4<br>- Brinde 5';
                break;
            case 'Capítulo Cinco - A Primeira Última Vez':
                message = 'Parabéns, você finalizou a leitura do capítulo cinco e desbloqueou alguns itens:<br><br>- Comentários da autora sobre o capítulo cinco<br>- Brinde 6';
                break;
